<?php
class Default_action_MenuThumbnailList_20424e72b961844642003d2db69a7a3a7513e0b8 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
return $renderingContext->getVariableProvider()->getByPath('settings.responsiveimages.contentelements.menu_thumbnail_list.{data.pi_flexform.columns}');
};
