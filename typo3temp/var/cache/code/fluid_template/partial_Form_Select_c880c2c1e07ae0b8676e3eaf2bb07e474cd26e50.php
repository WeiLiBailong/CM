<?php
class partial_Form_Select_c880c2c1e07ae0b8676e3eaf2bb07e474cd26e50 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output4 .= '" class="typo3-adminPanel-form-select-label">
                ';
...
$output4 .= '" class="typo3-adminPanel-form-select-input">
...
$output9 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('option.{optionValue}')]);

$output9 .= '" ';
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper

$array11 = [
'0' => $renderingContext->getVariableProvider()->getByPath('option.{optionValue}'),
'1' => ' == ',
...
$output9 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('option.{optionLabel}')]);
